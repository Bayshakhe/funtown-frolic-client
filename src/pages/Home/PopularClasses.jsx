...
const PopularClasses = () => {
    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
            {
                danceClasses.map((a) => <div key={a._id} className="card card-side bg-base-100 shadow-xl grid grid-cols-2">
                <figure><img className='h-64 rounded-xl ml-4' src={a.classImg} alt="Dance classes"/></figure>
